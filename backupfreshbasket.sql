...
\restrict 1c6SBE1KYJQ6tdgliYWYrzGRtJz7REfmIjN2AEvPmfffaGPbXDExWdF8oSV6UQ8
...
CREATE FUNCTION public.process_auditlogs() RETURNS trigger
    ...
    AS $$
DECLARE
    current_user_id INT; -- O VARCHAR si tus IDs de usuario son UUID/Texto
BEGIN
    -- Intentar obtener el ID del usuario desde una variable de sesión de la app
    -- Si tu backend no la setea, por defecto quedará en NULL o un ID del sistema
    BEGIN
    ...
    IF (TG_OP = 'INSERT' OR TG_OP = 'UPDATE') THEN
        ...
        VALUES (TG_RELNAME, NEW.id, TG_OP, current_user_id, CURRENT_TIMESTAMP);
        RETURN NEW;
    ELSIF (TG_OP = 'DELETE') THEN
        INSERT INTO audit_logs (entity, entity_id, action, user_id, created_at)
        VALUES (TG_RELNAME, OLD.id, TG_OP, current_user_id, CURRENT_TIMESTAMP);
        RETURN OLD;
    END IF;
    RETURN NULL;
END;
...
2	2026-04-30 14:15:37.642247	40	2.55	3	3	1	t
...
5	2026-06-02 20:15:39.12912	35	3	13	f
...
19	Cereal Zucaritas Clasico	3.85	0	https://tse3.mm.bing.net/th/id/OIP.5mcVa3kaGxjfCnMfJncXFgHaHa?r=0&rs=1&pid=ImgDetMain&o=7&rm=3	cereal en presentación de 620 g clasico	10	16	11	f
...
1	Manzana Roja	0.50	150	https://tse1.mm.bing.net/th/id/OIP.LAlScQZ3K4VPUUJ35dVUgQHaFl?r=0&rs=1&pid=ImgDetMain&o=7&rm=3	Manzana importada desde Estados Unidos	1	2	4	t
9	Harina de trigo	2.50	85	https://convy.mx/cdn/shop/products/70501659.jpg?v=1636474778	Harina de trigo en presentacion de 1 libra	7	8	1	f
...
22	Lechuga Fresh Green	1.65	80	https://tse1.mm.bing.net/th/id/OIP.ViuwTjeGQcNf08UgY3KDagAAAA?r=0&w=320&h=320&rs=1&pid=ImgDetMain&o=7&rm=3	Lechuga fresca nacional precio por unidad	3	3	11	f
...
3	Leche en polvo Australian 1Kg	2.55	185	https://cdn.phototourl.com/free/2026-05-19-30e9bd36-0465-4c2d-b73f-6ee0e12615e4.jpg	Leche importada desde Australia	2	1	4	t
\.
...
1	Australian	Leches SA de CV	2490-6789	leches.australian@mail.com	195 Marine Paradise, Camberra	2	t
...
16	Selecta	Alimentos	+24 2345 8987	selectaAlimentos@mail.com	Av. Benito Juarez 1586, Ciudad Juarez	15	f
19	La Granja	Hermanos Ltd.	+503 2543-6787	lagranjahermanos@mail.com	Canton Matazano, calle al Jicaro, Quezaltepeque	3	f
...
23	Domenico	Santorini	domenico.santorini@mail.com	+12 4080 345 234	$2a$10$z9kpmhe5YVCMmQCfnm4MheklAJtJ0M4eljTvNfBnVWeHz84iDd7kq	2	CLIENTE	f
24	Eduardo Francois	Camavinga	eduardo.camavinga@mail.com	+15 456 78904	$2a$10$vvErZZgREUaw1bCFgtiK5.K9CZfGFsv4U0tWbXfi1c8Cp3RhPCFem	10	CLIENTE	f
31	Josep Albert	MackNail	josepalbert@mail.com	7865-1324	$2a$10$kYiHyHGWYKI9RkiMJAwQC.vS1ViAEbPwJoMHyYUjC2PIQgGux9Btm	10	ADMINISTRADOR	t
...
30	Anibal de la Fuente	Gaitán	anibalgaitan@mail.com	+55 234567 234	$2a$10$gF3YaOUSOXfCdYCvCFWzjeZNGqNCAWnXQTrULqyZYSbK8kD6Wkx5m	15	CLIENTE	t
...
SELECT pg_catalog.setval('public.auditlogs_audit_id_seq', 118, true);
...
SELECT pg_catalog.setval('public.entries_id_seq', 25, true);
...
SELECT pg_catalog.setval('public.exits_id_seq', 6, true);
...
\unrestrict 1c6SBE1KYJQ6tdgliYWYrzGRtJz7REfmIjN2AEvPmfffaGPbXDExWdF8oSV6UQ8
